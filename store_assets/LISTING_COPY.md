# Silver Suite â€” Store Listing Copy
...
### App Name (30 char â€” primary SEO)
```
...
```
**32 chars** â€” if Apple rejects, use: `Big Buttons, Pills & SOS` (24 chars).

### Keywords (100 char â€” comma-separated, no spaces, singular)
```
senior,accessibility,pill,reminder,SOS,contact,magnifier,flashlight,large,text,elderly,caregiver
```
**97 chars.** Omits "Silver Suite", "button", "simple" â€” those appear in title/subtitle and are auto-indexed.

### Promotional Text (170 chars â€” updateable without new version)
```
The phone app finally built for Mom and Dad. Big tap targets, pill reminders, one-tap SOS, and a flashlight â€” all in one calm, high-contrast screen.
```
**149 chars.**
...
â€” For the adult child setting this up â€”

You know the drill: you hand Mom a smartphone and a week later she's calling you because she can't find the flashlight. Silver Suite fixes that. One install. Five minutes of setup. Nine tools your parent can actually find and use on their own. The first time they call you because they want to â€” not because they're lost in a menu â€” you'll know it worked.

â€” For the senior using it every day â€”
...
â€¢ Big Clock â€” date, day, and time front and center, always readable.
â€¢ Pill Reminders â€” add a medication, set the times, mark it taken in one tap. Color-coded per pill. No app subscription required for this core feature.
â€¢ One-Tap Contacts â€” favorite family members as "Emergency" contacts; they surface first at the top and on the SOS screen.
â€¢ SOS Screen â€” a pulsing 911 button with one confirmation step (no accidental calls), plus your emergency contacts right below.
â€¢ Flashlight â€” camera torch on phones that support it; full-screen white light fallback on every other device. It just works.
â€¢ Magnifier â€” paste any text and zoom it from 24 to 120-point type. High-contrast and bold toggle included. No camera permission needed.
â€¢ Notes â€” large-text notes that never shrink. Exactly what it says.
â€¢ Big Calculator â€” four functions, keys sized for confidence. No scientific-mode clutter.
â€¢ Accessibility Settings â€” three text-size presets (Standard / Large / Extra Large) apply everywhere, instantly. Dark mode included.
...
PREMIUM
Start with 7 days free, then keep the full suite with one lifetime purchase:
â€¢ No ads, ever
â€¢ Unlimited pill schedules (free tier: 5)
...
```
First release. Big clock, pill reminders, one-tap SOS, flashlight, magnifier, notes, calculator, and contacts â€” all built for 60+ eyes and steadier taps.
```
**153 chars.**
...
### App Review â€” Review Notes
```
Silver Suite is a local-first senior utility app. No account or login. All data (pill schedules, contacts, notes, settings, premium status) is stored on-device via SharedPreferences. Monetization is a 7-day local trial followed by one non-consumable IAP: ss_premium_lifetime. To test IAP: launch app, open the More tab, tap the Silver+ card, and confirm the lifetime purchase in sandbox. Restore Purchases button is on the paywall screen. Camera permission is used only by the torch_light plugin to toggle the device flashlight; the Magnifier feature is text-paste based and requires no camera permission.
```
...
### App Category
**Tools** (primary) â€” closest Play equivalent to Utilities.
...
### Target Audience
**Ages 18+** â€” primary users are seniors (60+) and adult children (25â€“55) setting up for a parent.
...
| Description | `7-day local trial, then pay once. Keep forever. No ads and unlimited everything.` |
| Price | $49.99 USD |
| State | Active |
...
| 04_sos | `SOS â€” ready when it matters.` |
...
| Targets children under 13 | No â€” audience is 60+ seniors and adult children |
| Digital purchases (IAPs) | Yes |
| Includes ads | Yes â€” banner only |
